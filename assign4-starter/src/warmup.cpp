...
// This is a correct version that uses recursion to explore
// all possible subsets of elements from v and returns count
// of how many of those subsets sum to zero
...
// Moves the given number of discs from the given starting peg
// to the given ending peg using specified temporary peg.
// Uses the functions of the HanoiGui to visually animate the movement.
// Also counts the total number of moves made in the given int reference.
...
// Initializes the HanoiGui for the proper number of discs and
// then recursively moves a tower from peg to peg.
void hanoiAnimation() {
    int numDiscs = 4;
